...
.LFE1:
	...
	.section	.text.ccm_ctr_mode,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	ccm_ctr_mode, %function
ccm_ctr_mode:
.LFB2:
	.loc 1 95 0
...
.LCFI7:
	...
	ldr	pc, [sp], #4
.LFE2:
	.size	ccm_ctr_mode, .-ccm_ctr_mode
	.section	.text.tc_ccm_generation_encryption,"ax",%progbits
	.align	1
	.global	tc_ccm_generation_encryption
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
...
.LFE3:
	...
	.align	1
	.global	tc_ccm_decryption_verification
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
...
.Ldebug_abbrev0:
	...
	.4byte	0x916
	.4byte	0x65c
	.ascii	"tc_ccm_decryption_verification\000"
	.4byte	0x712
	.ascii	"tc_ccm_generation_encryption\000"
	.4byte	0x7b2
	.ascii	"ccm_ctr_mode\000"
	.4byte	0x855
	.ascii	"ccm_cbc_mac\000"
	.4byte	0x8bb
	.ascii	"tc_ccm_config\000"
	.4byte	0
	...
	.4byte	0x5d9
	.ascii	"tc_ccm_mode_struct\000"
	.4byte	0x610
	.ascii	"TCCcmMode_t\000"
	.4byte	0x621
	.ascii	"FILE\000"
	.4byte	0
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro3
	.byte	0x4
	.file 7 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 4.12/include/stddef.h"
	.byte	0x3
	.uleb128 0x4e
	.uleb128 0x7
	.byte	0x5
...
.Ldebug_macro5:
	...
	.4byte	.LASF551
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.tc_ccm_mode.h.85.6b0773bd0840b20313bc7e4ae0d1a534,comdat
.Ldebug_macro6:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF552:
	.ascii	"TC_CCM_AAD_MAX_BYTES 0xff00\000"
.LASF192:
...
.LASF553:
	.ascii	"TC_CCM_PAYLOAD_MAX_BYTES 0x10000\000"
.LASF352:
...
.LASF694:
	.ascii	"C:\\Users\\Rena Li\\Desktop\\ndn-lite-android-suppo"
	.ascii	"rt-library\\nRF52840_example\\Application\\ndn_stan"
	.ascii	"dalone\\security\\sec-lib\\tinycrypt\\tc_ccm_mode.c"
	.ascii	"\000"
.LASF471:
