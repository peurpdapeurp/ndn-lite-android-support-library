...
g_rng_function:
	.space	4
	.section	.text.tc_uECC_make_key_with_d,"ax",%progbits
	.align	1
	.global	tc_uECC_make_key_with_d
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	tc_uECC_make_key_with_d, %function
...
.LCFI2:
	...
	ldr	pc, [sp], #4
.LFE0:
	.size	tc_uECC_make_key_with_d, .-tc_uECC_make_key_with_d
	.section	.text.tc_uECC_make_key,"ax",%progbits
	.align	1
	.global	tc_uECC_make_key
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	tc_uECC_make_key, %function
tc_uECC_make_key:
.LFB1:
	.loc 1 103 0
...
.LCFI5:
	...
	ldr	pc, [sp], #4
.LFE1:
	.size	tc_uECC_make_key, .-tc_uECC_make_key
	.section	.text.tc_uECC_shared_secret,"ax",%progbits
	.align	1
	.global	tc_uECC_shared_secret
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	tc_uECC_shared_secret, %function
...
.L17:
	...
	ldrsb	r2, [sp, #167]
	mov	r1, r3
	bl	tc_uECC_generate_random_int
	mov	r3, r0
	cmp	r3, #0
	bne	.L19
	.loc 1 178 0
...
.L22:
	.word	g_rng_function
.LFE2:
	.size	tc_uECC_shared_secret, .-tc_uECC_shared_secret
...
.Ldebug_abbrev0:
	...
	.4byte	0x728
	.ascii	"tc_uECC_shared_secret\000"
	.4byte	0x81e
	.ascii	"tc_uECC_make_key\000"
	.4byte	0x8b8
	.ascii	"tc_uECC_make_key_with_d\000"
	.4byte	0
	...
	.4byte	0x1d3
	.ascii	"tc_uECC_RNG_Function\000"
	.4byte	0x223
	.ascii	"long int\000"
	.4byte	0x1fe
...
.Ldebug_macro0:
	...
	.uleb128 0x28
	.4byte	.LASF459
	.file 6 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 4.12/include/stdbool.h"
	.byte	0x3
	.uleb128 0x2e
	.uleb128 0x6
	.byte	0x7
	...
	.4byte	.LASF542
	.byte	0x4
	.file 8 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 4.12/include/string.h"
	.byte	0x3
	.uleb128 0x3c
	.uleb128 0x8
	.byte	0x5
...
.Ldebug_macro4:
	...
	.4byte	.LASF529
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.tc_ecc.h.81.96c6dd1df0d862199e7df870e8a9f167,comdat
.Ldebug_macro5:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF680:
	.ascii	"C:\\Users\\Rena Li\\Desktop\\ndn-lite-android-suppo"
	.ascii	"rt-library\\nRF52840_example\\Application\\ndn_stan"
	.ascii	"dalone\\security\\sec-lib\\tinycrypt\\tc_ecc_dh.c\000"
.LASF673:
	.ascii	"carry\000"
.LASF236:
