...
import static NDNLiteSupport.SignOnBasicControllerBLE.secureSignOn.secureSignOnVariants.SecureSignOnVariantStrings.*;
import static NDNLiteSupport.SignOnBasicControllerBLE.secureSignOn.tlv.secureSignOnTlvConsts.*;

import net.named_data.jndn.security.v2.CertificateV2;

import NDNLiteSupport.SignOnBasicControllerBLE.secureSignOn.SignOnControllerResults;

import static NDNLiteSupport.SignOnBasicControllerBLE.secureSignOn.SignOnControllerResultCodes.*;
import static NDNLiteSupport.NDNLiteAndroidSupportConsts.*;
