...
import static NDNLiteSupport.SignOnBasicControllerBLE.secureSignOn.secureSignOnVariants.basic.SignOnBasicControllerResultCodes.*;
import NDNLiteSupport.SignOnBasicControllerBLE.secureSignOn.secureSignOnVariants.basic.SignOnBasicControllerResults.*;
...
public abstract class SignOnBasicController extends SignOnController {
    ...
    ParseBootstrappingRequestResult parseBootstrappingRequest(byte[] bootstrappingRequest) {
        ...
        result = secureSignOnTlvParsingHelpers.parseTlvValue(bootstrappingRequest, secureSignOnTlvConsts.SECURE_SIGN_ON_BLE_BOOTSTRAPPING_REQUEST_TLV_TYPE);
        ...
        result = secureSignOnTlvParsingHelpers.parseTlvValue(bootstrappingRequestTlvValue, secureSignOnTlvConsts.SECURE_SIGN_ON_BLE_SIGNATURE_TLV_TYPE);
        if (result.resultCode != secureSignOnTlvResultCodes.ParseTlvValueResultCode.SUCCESS) {
